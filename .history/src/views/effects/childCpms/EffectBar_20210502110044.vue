<template>
  <div class="bar" ref="bar">
    <bar-item message="LinearBall" @click.native="toLinearBall"/>
    <bar-item message="ColorfulBall" @click.native="toColorfulBall"/>
    <bar-item message="Clock" @click.native="toColorfulBall"/>
    <bar-item message="CSS3" @click.native="toColorfulBall"/>
    <bar-item message="WEBPACK" @click.native="toColorfulBall"/>
    <bar-item message="Canvas" @click.native="toColorfulBall"/>
    <bar-item message="Vue.js" @click.native="toColorfulBall"/>
  </div>
</template>
